...
stats_content = """import { Activity, Droplet, Hash, TrendingUp, DollarSign } from "lucide-react";
...
with open("src/components/StockStats.jsx", "w") as f:
    f.write(stats_content)

print("Updated StockStats.jsx via python")
